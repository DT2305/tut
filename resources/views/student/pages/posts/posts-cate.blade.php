...
@section('breadcrumb_2')
    ...
    <p class="bcrumb text-center"><a href="">Trang chủ</a>
        ...
        <span class="current"> <a href="{{route('student.get.index')}}">Tin tức</a></span>
        <span class="sep ion-android-arrow-dropright px-2"></span>
                    ...
                    @foreach($pos as $val)
                        <div class="col-md-12 col-lg-12 mb-5">
                            <div class="block-20 ">
                                ...
                                <div class="text">
                                    <h3 class="heading"><a
                                            href="{{route('student.get.content',$val->changedtitle)}}">{{$val->title}}</a>
                                    </h3>
                                    <div class="meta">
                                        <div><a><span
                                        ...
                                        <div><a><span
                                                    class="ion-code"></span> {{$val->show_category->name}}
                                            </a></div>
                                    </div>
                                </div>
                            </div>
