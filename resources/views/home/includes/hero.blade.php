            ...
            <div class="col-md-12 text-center">
                ...
                <div class="mb-5 element-animate">
                    <div class="block-17 py-3">
                        @if(!Auth::check())
                            <h2 class="heading text-center mb-4 font-weight-bold">Bước đầu để trở thành sinh viên chính
                                thức</h2>

                            <p class="text-center mb-3 ">Đăng ký để cập nhật thêm thông tin tuyển sinh</p>
                            <p class="text-center"><a href="{{route('home.get.regis')}}" class="btn py-3 px-5" style="border-radius:100px ">Đăng ký
                                    ngay</a></p>
                        @endif
                        @if(Auth::check())
