<header role="banner">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand absolute" href="{{route('home.get.welcome')}}"><img src="/img/ctut_logo.png" alt=""
            ...
            <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('home.get.index')}}">Trang chủ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('home.get.welcome')}}">Giới thiệu</a>
                    </li>
...
{{--                    </li>--}}
                ...
                <ul class="navbar-nav absolute-right">
                    @if(!Auth::check())
                        <li>
                            <a href="{{route('home.get.login')}}">Đăng nhập</a> / <a href="{{route('home.get.regis')}}">Đăng ký</a>
                        </li>
                    @endif
                    @if(Auth::check())
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown05">
                                <a class="dropdown-item" href="{{route('home.get.info')}}">Cập nhật thông tin</a>
