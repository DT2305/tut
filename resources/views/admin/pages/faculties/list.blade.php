        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <a class="btn btn-success" href="{{route('admin.faculties.create')}}">Thêm ngành</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        @foreach($fal as $key=> $val)

                            <tr>
                                <td width="3%">{{$key}}</td>
                                <td>{{$val->faculty_code}}</td>
                                <td>{{$val->name}}</td>
                                <td>{{$val->show_department->name}}</td>
                                <td width="15%">
                                    <div class="dropdown dropleft float-right">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('admin.faculties.show',$val->id)}}">
                                                <i class="fas fa-info text-warning mr-2"></i>Xem chi tiết</a>
                                            <a class="dropdown-item" href="{{route('admin.faculties.edit',$val->id)}}">
                                                <i class="fas fa-pen text-success mr-2"></i>Sửa</a>
                                            <a class="dropdown-item confirmClick" href="{{route('admin.faculties.destroy',$val->id)}}">
